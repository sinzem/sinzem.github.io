...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = "Please select the painting size and material";
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      console.log(api);
      (0,_services_requests__WEBPACK_IMPORTED_MODULE_5__.postData)(api, formData).then(function (res) {
        console.log(res);
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (gift) gift.style.right = "calc(32px + ".concat(scroll, "px)");
      });
    });
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    (0,_services_requests__WEBPACK_IMPORTED_MODULE_4__.getResource)( /* 'http://localhost:3000/styles' */'assets/db.json').then(function (res) {
      return createCards( /* res */res.styles);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_drag__WEBPACK_IMPORTED_MODULE_12__["default"])();
});
}();
/******/ })()
;
